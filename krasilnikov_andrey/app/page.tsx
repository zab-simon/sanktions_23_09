...
// framer-motion removed for stability (no client animation dependency)
...
const secondarySanctionsData = [
  { country: "Moscow", risk: 65, fill: "#0072CE" },
  { country: "Ekaterinburg", risk: 60, fill: "#00A65A" },
  { country: "Bali", risk: 15, fill: "#F59E0B" },
  { country: "Thailand", risk: 25, fill: "#6B7280" },
  { country: "UAE", risk: 30, fill: "#D32F2F" },
];

// Capital Mobility Risk (1Y probability of capital restrictions)
const capitalMobilityData = [
  { country: "Moscow", risk: 70, fill: "#0072CE" },
  { country: "Ekaterinburg", risk: 65, fill: "#00A65A" },
  { country: "Bali", risk: 20, fill: "#F59E0B" },
  { country: "Thailand", risk: 35, fill: "#6B7280" },
  { country: "UAE", risk: 25, fill: "#D32F2F" },
];
  ...
  return (
    <div className="p-6 grid grid-cols-1 lg:grid-cols-2 gap-6 bg-[#000000] text-[#F3F4F6] min-h-screen">
      ...
      <Card className="bg-[#111827] rounded-2xl shadow-xl">
        <CardContent>
          <h2 className="text-2xl font-bold mb-4 text-white">
            Capital Mobility Risk (1Y Probability %)
          </h2>
          <div className="mb-4 text-sm text-[#9CA3AF]">
            Probability of capital transfer restrictions or repatriation limits by jurisdiction.
          </div>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={capitalMobilityData}>
              <CartesianGrid stroke="#2A2F36" strokeDasharray="3 3" />
              <XAxis dataKey="country" stroke="#F3F4F6" />
              <YAxis stroke="#F3F4F6" tickFormatter={(v) => `${v}%`} />
              <Tooltip contentStyle={tooltipStyle} />
              <Bar dataKey="risk">
                {capitalMobilityData.map((entry, index) => (
